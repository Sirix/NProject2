<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<NProject.ViewModels.TaskListViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>"<%: Model.ProjectTitle %>" tasks</h2>
     <p>
        <%: Html.ActionLink("Back to projects", "List", "Project")%>
    </p>
    <table>
        <tr>
            <th></th>
